...
public class Planner {
    ...
    public ArrayList<List<Action>> getPlan() {
        ...
        if (plan != null) {
            // plano é na ordem inversa da extração
    ...
    // backtracking no grafo expandido em busca de plano válido
    ...
    // se últimos action e state levels forem iguais: pára.
